...
func _update_camera() -> void:
	...
	# Step 1: move camera parallel to ground plane toward/away from player to maintain distance
	...
	# Step 2: move camera vertically to maintain height above player
	cam_pos.y = player_pos.y + camera_height

	# Step 3: apply position and look at player
